/*
    ...
    myLaptop addAction ["Take Laptop", { _this call compile preprocessFileLineNumbers "attachLaptop.sqf"; }, nil, 1.5, true, true, "", "isNull (_this getVariable [""attachedObject"", objNull])", 2];
*/
...
if (isNull _attachedObject) then {
    ...
    _caller setVariable ["attachedObject", _target, true];
    ...
    hint "Script Error: Try to attach a new object, but another is already attached.";
};
